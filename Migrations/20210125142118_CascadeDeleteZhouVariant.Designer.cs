...
namespace PcrBattleChannel.Migrations
{
    ...
    [Migration("20210125142118_CascadeDeleteZhouVariant")]
    partial class CascadeDeleteZhouVariant
    {
            ...
            modelBuilder.Entity("PcrBattleChannel.Models.ZhouVariantCharacterConfig", b =>
                {
                    ...
                    b.HasOne("PcrBattleChannel.Models.ZhouVariant", null)
                        .WithMany("CharacterConfigs")
                        .HasForeignKey("ZhouVariantID1");
